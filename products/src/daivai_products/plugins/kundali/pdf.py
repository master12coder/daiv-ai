"""PDF kundali assembler — 3 formats with Sanatan Dharma aesthetic.

Orchestrates all renderers into a single PDF document.
...
def _render_shadbala(chart: ChartData, sb: list) -> bytes | None:
    try:
        from daivai_products.plugins.kundali.shadbala_chart import render_shadbala_chart
