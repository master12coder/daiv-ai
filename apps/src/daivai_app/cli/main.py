...
def report(
    ...
    if llm != "none":
        try:
            from daivai_products.interpret.factory import get_backend
            from daivai_products.interpret.renderer import interpret_chart
...
def cli() -> None:
    ...
    import daivai_app.cli.commands  # noqa: F401 — registers commands on main group
